...
def sol(draw_numbers: list, bingo_boards: dict):
    ...
    for draw_number in draw_numbers:
        ...
        for key in bingo_boards:
            ...
            for i in range(len(bingo_board)):
                for j in range(len(bingo_board)):
                    if bingo_board[i][j] == draw_number:
                        ...
                        # print(f'Board number {key} marked:')
                        # print(
            ...
            if winner == True:
                ...
                winning_sum = sum
                # print(f"Board number {key} just won")
                ...
                winning_board_numbers.append(
                    [winning_draw_number, winning_sum])

    return winning_board_numbers[-1][0] * winning_board_numbers[-1][1]
